...
class SomeTests(UnitTests):
    ...
    def test_undirected_cyclic(self):
        self._act_assert('G-ex', '?')
        self._act_assert('K3-0', '?')
        self._act_assert('rusty-1-17', '?')
        self._act_assert('grid-5-0', '?')
        self._act_assert('wall-p-1', '?')
        self._act_assert('wall-p-3', '?')
        self._act_assert('wall-z-3', '?')
        self._act_assert('wall-n-2', '?')
